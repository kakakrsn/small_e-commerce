...
class HomePageController extends GetxController {
  ...
  getCardList() async{
    try {
      ...
      list.forEach((element) {
        cartItems.add(ShopDataModel.fromJson(element));
      });
      update();
  ...
  loadItems()async{
    try {
      ...
      list.forEach((element) {
        items.add(ShopDataModel.fromJson(element));
      });
  ...
  Future addToCart(ShopDataModel item) async {
    isLoading = true;
    update();
